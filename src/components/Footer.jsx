    ...
    <div className="footer">
      <div className="footer-content">
        ...
        <div className="socials">
          ...
          <div className="logo">
            <a href="https://instagram.com/devarsheegaunekar" target="_blank">
              <i class="fa-brands fa-instagram footer-icons"></i>
            </a>
            <a href="https://twitter.com/devarsheecodess" target="_blank">
            ...
            <a href="https://github.com/devarsheecodess" target="_blank">
              <i class="fa-brands fa-square-github footer-icons"></i>
            </a>
            <a
              href="https://www.facebook.com/profile.php?id=100066272635870"
              target="_blank"
            >
